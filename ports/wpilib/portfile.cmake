...
foreach(wpi_pkg IN LISTS PACKAGES_TO_FIXUP)
  ...
  string(TOLOWER "${wpi_pkg}" wpi_pkg_lower)
  file(READ "${CURRENT_PACKAGES_DIR}/share/${wpi_pkg}/${wpi_pkg_lower}-config.cmake" WPI_CONFIG_CONTENTS)
  string(REPLACE "/share/openjpeg/" "/share/${wpi_pkg}/" WPI_CONFIG_CONTENTS "${WPI_CONFIG_CONTENTS}")
  file(WRITE "${CURRENT_PACKAGES_DIR}/share/${wpi_pkg}/${wpi_pkg_lower}-config.cmake" "${WPI_CONFIG_CONTENTS}")
endforeach()
